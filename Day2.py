...
print(f"Prediction for first test image: {np.argmax(predictions[6])}")

plt.imshow(test_images[6].reshape(28,28), cmap='gray')
plt.title(f"Predicted Label: {predictions[6].argmax()}")
plt.show()

#Learn with Sagarcodev